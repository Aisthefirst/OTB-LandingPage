          ...
          {solutions.map((solution, index) => (
            <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <button className={`w-full border border-${solution.color}-600 text-${solution.color}-600 hover:bg-${solution.color}-50 px-4 py-2 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors`}>
                  Learn More
