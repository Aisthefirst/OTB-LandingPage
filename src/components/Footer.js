        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Livestock Monitoring</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Resource Optimization</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Analytics Platform</a></li>
            </ul>
          </div>
